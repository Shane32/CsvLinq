...
public class CsvContextTests
{
    ...
    [TestMethod]
    public async Task LoadAsyncUsesBufferedParserReads()
    {
        ...
        Assert.IsTrue(reader.ReadAsyncCallCount < 100, "Expected buffered reads rather than one read per character.");
    }
